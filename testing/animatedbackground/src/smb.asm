...
@CycleCHR:
      ...
      and #%00000001
      bne @exit
      ; ignore cycling if we're not in an above ground area
      lda AreaType
      cmp #1
      beq @IncrementSelectedCHR
@exit:
      rts
@IncrementSelectedCHR:
      ; cycle through all the CHRs one at a time
      inc SelectedCHR
      lda SelectedCHR
      cmp #6
      bcc UpdateCHR1
...
ClrMTBuf: sta MetatileBuffer,x       ;clear out metatile buffer
          ...
          bpl ClrMTBuf
          nop
          ldy #0      ;do we need to render the background scenery?
...
VPipeSectLoop: lda #$80                 ;all the way to the top of the screen
...
GameCoreRoutine:
      ...
      jsr CycleCHR           ;execute one of many possible subs
