...
SetStPos: lda PlayerStarting_X_Pos,y  ;load appropriate horizontal position
          ...
          sta GameTimerDisplay+1        ;use value of game timer control for first digit of game timer
          lda #$01
          sta GameTimerDisplay+2      ;set last digit of game timer to 1
          lsr
          sta GameTimerDisplay      ;set second digit of game timer
...
CoinPoints:
      lda #$04               ;set digit modifier to award
...
AwardGameTimerPoints:
         ...
         lda FrameCounter
         and #%00000001         ;check frame counter for d2 set (skip ahead
         bne NoTTick2            ;for four frames every four frames) branch if not set
         lda #Sfx_TimerTick
